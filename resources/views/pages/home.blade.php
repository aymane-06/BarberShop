...
<head>
              ...
              <meta name="description" content="Find and book the best barbers in your area. Quick, easy and reliable booking for your next perfect cut.">
...
<body class="bg-gray-50">
              ...
              <section class="relative overflow-hidden">
                            <div class="hero-gradient text-white">
                                          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-32 flex flex-col md:flex-row items-center">
                                                        <div class="md:w-1/2 lg:pr-12 mb-10 md:mb-0" data-aos="fade-right" data-aos-duration="1000">
                                                                      ...
                                                                      <p class="text-lg mb-8 text-gray-100 max-w-lg">Discover top-rated barbers in your area and book appointments with ease. No more waiting in line for your next haircut.</p>
                                                                      <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                                                                    <a href="/register" class="bg-white text-primary-700 px-6 py-3 rounded-md font-medium text-center shadow-lg hover:bg-gray-100 transition-all transform hover:scale-105">Book Now</a>
                                                                                    <a href="/barbers/register" class="bg-transparent border-2 border-white text-white px-6 py-3 rounded-md font-medium text-center hover:bg-white hover:text-primary-700 transition-all transform hover:scale-105">Register as a Barber</a>
                                                                      </div>
                                                        </div>
                                                        <div class="md:w-1/2 relative" data-aos="fade-left" data-aos-duration="1000">
                                                                      <img src="https://images.unsplash.com/photo-1503951914875-452162b0f3f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=500&q=80" alt="Barber Shop" class="rounded-lg shadow-2xl relative z-10 floating">
              ...
              <section id="features" class="py-16 bg-gray-50">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                          ...
                                          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                                        <!-- Feature 1 -->
                                                        <div class="bg-white p-6 rounded-lg shadow transition-all duration-300 card-hover" data-aos="zoom-in" data-aos-delay="100">
                                                        ...
                                                        <!-- Feature 2 -->
                                                        <div class="bg-white p-6 rounded-lg shadow transition-all duration-300 card-hover" data-aos="zoom-in" data-aos-delay="200">
                                                                      <div class="rounded-full bg-primary-100 w-14 h-14 flex items-center justify-center mb-4">
                                                        ...
                                                        <!-- Feature 3 -->
                                                        <div class="bg-white p-6 rounded-lg shadow transition-all duration-300 card-hover" data-aos="zoom-in" data-aos-delay="300">
                                                                      <div class="rounded-full bg-primary-100 w-14 h-14 flex items-center justify-center mb-4">
                                                        ...
                                                        <!-- Feature 4 -->
                                                        <div class="bg-white p-6 rounded-lg shadow transition-all duration-300 card-hover" data-aos="zoom-in" data-aos-delay="400">
                                                                      <div class="rounded-full bg-primary-100 w-14 h-14 flex items-center justify-center mb-4">
                                                        ...
                                                        <!-- Feature 5 -->
                                                        <div class="bg-white p-6 rounded-lg shadow transition-all duration-300 card-hover" data-aos="zoom-in" data-aos-delay="500">
                                                                      <div class="rounded-full bg-primary-100 w-14 h-14 flex items-center justify-center mb-4">
                                                        ...
                                                        <!-- Feature 6 -->
                                                        <div class="bg-white p-6 rounded-lg shadow transition-all duration-300 card-hover" data-aos="zoom-in" data-aos-delay="600">
                                                                      <div class="rounded-full bg-primary-100 w-14 h-14 flex items-center justify-center mb-4">
                            ...
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                          ...
                                          <div class="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-8">
                                                        ...
                                                        <div class="flex flex-col items-center text-center w-full md:w-1/3" data-aos="fade-right" data-aos-delay="100">
                                                                      <div class="bg-primary-100 text-primary-600 rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold mb-4 transform transition-all hover:scale-110 hover:bg-primary-200">1</div>
                                                        ...
                                                        <div class="flex flex-col items-center text-center w-full md:w-1/3" data-aos="fade-up" data-aos-delay="200">
                                                                      <div class="bg-primary-100 text-primary-600 rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold mb-4 transform transition-all hover:scale-110 hover:bg-primary-200">2</div>
                                                        ...
                                                        <div class="flex flex-col items-center text-center w-full md:w-1/3" data-aos="fade-left" data-aos-delay="300">
                                                                      <div class="bg-primary-100 text-primary-600 rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold mb-4 transform transition-all hover:scale-110 hover:bg-primary-200">3</div>
                                          ...
                                          <div class="mt-16 text-center" data-aos="zoom-in" data-aos-delay="400">
                                                        <a href="/register" class="bg-primary-600 text-white px-8 py-3 rounded-md font-medium inline-block hover:bg-primary-700 transition-all transform hover:scale-105 shadow-md">Get Started Now</a>
                                          </div>
                            </div>
              </section>
              ...
              <section id="testimonials" class="py-16 bg-gray-50">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                          ...
                                          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                                        <!-- Testimonial 1 -->
                                                        <div class="bg-white p-6 rounded-lg shadow-md testimonial-card transform transition-all hover:-translate-y-2 hover:shadow-lg" data-aos="flip-left" data-aos-delay="100">
                                                                      ...
                                                                      <p class="text-gray-600 mb-6">"I used to waste so much time waiting at my local barbershop. With CutBook, I just book my slot and show up right on time. It's been a game-changer!"</p>
                                                                      <div class="flex items-center">
                                                                                    <div class="bg-gradient-to-br from-primary-200 to-primary-300 rounded-full w-12 h-12 flex items-center justify-center mr-3">
                                                        ...
                                                        <!-- Testimonial 2 -->
                                                        <div class="bg-white p-6 rounded-lg shadow-md testimonial-card transform transition-all hover:-translate-y-2 hover:shadow-lg" data-aos="flip-left" data-aos-delay="200">
                                                                      <div class="flex items-center mb-4">
                                                                                    <div class="text-yellow-400 flex">
                                                                                                  <i class="fas fa-star"></i>
                                                                                                  <i class="fas fa-star"></i>
                                                                      ...
                                                                      <p class="text-gray-600 mb-6">"As a barbershop owner, this platform has helped me organize my appointments and attract new customers. The notification system keeps no-shows to a minimum."</p>
                                                                      <div class="flex items-center">
                                                                                    <div class="bg-gradient-to-br from-primary-200 to-primary-300 rounded-full w-12 h-12 flex items-center justify-center mr-3">
                                                        ...
                                                        <!-- Testimonial 3 -->
                                                        <div class="bg-white p-6 rounded-lg shadow-md testimonial-card transform transition-all hover:-translate-y-2 hover:shadow-lg" data-aos="flip-left" data-aos-delay="300">
                                                                      <div class="flex items-center mb-4">
                                                                                    <div class="text-yellow-400 flex">
                                                                                                  <i class="fas fa-star"></i>
                                                                                                  <i class="fas fa-star"></i>
                                                                      ...
                                                                      <p class="text-gray-600 mb-6">"I travel a lot for work and finding good barbers used to be hit or miss. Now I can check ratings and book in advance wherever I go. Love this service!"</p>
                                                                      <div class="flex items-center">
                                                                                    <div class="bg-gradient-to-br from-primary-200 to-primary-300 rounded-full w-12 h-12 flex items-center justify-center mr-3">
              ...
              <section class="py-20 bg-primary-600 text-white relative overflow-hidden">
                            <div class="absolute top-0 right-0 w-64 h-64 bg-white rounded-full opacity-10 -mr-32 -mt-32" data-aos="fade-down-left"></div>
                            <div class="absolute bottom-0 left-0 w-80 h-80 bg-primary-400 rounded-full opacity-20 -ml-40 -mb-40" data-aos="fade-up-right"></div>
                            
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                                          <h2 class="text-3xl font-bold mb-6" data-aos="zoom-in">Ready for your next great haircut?</h2>
                                          <p class="text-lg mb-8 max-w-2xl mx-auto" data-aos="zoom-in" data-aos-delay="100">Join thousands of customers who have already simplified their barber booking experience with CutBook.</p>
                                          <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                                                        <a href="/register" class="bg-white text-primary-700 px-8 py-3 rounded-md font-medium inline-block hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg" data-aos="fade-up" data-aos-delay="200">Get Started</a>
                                                        <a href="/barbers" class="bg-transparent border-2 border-white text-white px-8 py-3 rounded-md font-medium inline-block hover:bg-white hover:text-primary-700 transition-all transform hover:scale-105" data-aos="fade-up" data-aos-delay="300">Find Barbers</a>
                                          </div>
                            </div>
              </section>
                                                                      ...
                                                                      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                                                                                                  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                                                                                                                                                                        ...
                                                                                                                                                                        <div>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <p class="mb-4 text-sm">Finding the perfect barber has never been easier. Book your next appointment in seconds.</p>

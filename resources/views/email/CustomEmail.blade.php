...
<body>
    <div class="container">
        ...
        <div class="barbershop-info">
            <p><span class="info-label">Barbershop:</span> {{ $barbershop->name ?? 'N/A' }}</p>
            <p><span class="info-label">Email:</span> {{ $barbershop->email ?? 'N/A' }}</p>
            <p><span class="info-label">Owner:</span> {{ $barbershop->owner_name ?? 'N/A' }}</p>
        </div>
        @endif
        ...
        <div class="message">
            @if(isset($CustomMessage))
                {!! $CustomMessage !!}
            @elseif(isset($reconsideration_notes))
                <h3>Reconsideration Request</h3>
                <p>We have received your request for reconsideration. Here are the details:</p>

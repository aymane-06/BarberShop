...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>A booking has been rescheduled and requires your attention</p>
        </div>
        
        <div class="content">
            <p>Hello {{ $booking->barbershop->name ?? 'Barbershop Owner' }},</p>
            
            <p>A booking with reference number <strong>{{ $booking->booking_reference }}</strong> has been rescheduled. Please review the updated details below.</p>
            
            <div class="booking-details">
                <div class="booking-item">
                    <strong>Client:</strong>
                    <span>{{ $booking->user->name ?? 'Client' }}</span>
                </div>
            ...
            <p>Please review this updated booking by clicking the button below to access your admin dashboard:</p>
            
            <a href="{{ route('barber.dashboard', $booking->id) }}" class="button">Review Updated Booking</a>
            
            <p>If you have any questions or need to contact the client directly, their email is {{ $booking->user->email ?? 'not available' }}.</p>
